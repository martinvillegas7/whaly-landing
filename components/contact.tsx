      ...
      <div className="max-w-7xl mx-auto">
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6 mb-12">
          {contactInfo.map((contact, index) => (
            ...
            >
              {/* Icon Circle */}
              <div className={`w-14 h-14 ${contact.accentColor} rounded-full flex items-center justify-center mb-5 transition-transform duration-200 group-hover:scale-110`}>
                {contact.label === "Teléfono" && (
              ...
              {/* Accent */}
              <div
                className={`h-1 w-16 ${contact.accentColor} rounded-full mt-6 transition-all duration-300 group-hover:w-20`}
              ></div>
            </a>
          ))}
        </div>
